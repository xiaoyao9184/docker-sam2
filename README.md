# Docker Segment Anything Model 2

A Docker image built through Github Actions with Git commit version tag

# Why

I found that sam2's Docker image is difficult to find.
The code on [GitHub](https://github.com/facebookresearch/sam2) does not provide a pre-built Docker image.
...
The images of this project will be published to Docker Hub under the repository [xiaoyao9184/sam2](https://hub.docker.com/r/xiaoyao9184/sam2).

Since this project references the sam2 project via a submodule, it cannot monitor push events on the sam2 project, and therefore cannot automatically create an image for every commit.
...
The default image name format is `${DOCKERHUB_USERNAME}/sam2`.
